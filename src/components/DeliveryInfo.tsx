...
const TIER_CONFIG = [
  ...
  { color: 'bg-primary-500', label: 'Island',  labelSw: 'Kisiwa',   textColor: 'text-primary-700', bg: 'bg-primary-50', border: 'border-primary-200'},
...
export function DeliveryInfo() {
  ...
  return (
    <section id="delivery" className="container-page py-6 scroll-mt-20">
      ...
      <div className="grid grid-cols-3 gap-3 mt-5">
        {[
          { icon: <Truck className="w-4 h-4 text-primary-500" />,  valueEn: 'Nationwide', valueSw: 'Nchi Nzima',     labelEn: 'Coverage',  labelSw: 'Maeneo' },
          ...
          <div key={s.labelEn} className="bg-white rounded-xl border border-gray-100 shadow-card p-3 flex flex-col items-center text-center gap-1.5">
      ...
      {/* ── CTA footer ── */}
      <div className="mt-4 flex items-center justify-between bg-primary-50 border border-primary-100 rounded-xl px-4 py-3">
        <p className="text-xs text-primary-700 font-medium leading-snug max-w-[65%]">
          {lang === 'sw'
        ...
        <motion.a
          href={WHATSAPP_LINK}
          whileTap={{ scale: 0.96 }}
          className="flex items-center gap-1.5 px-3.5 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-md text-xs font-bold transition-colors shadow-card outline-none [-webkit-tap-highlight-color:transparent]"
        >
